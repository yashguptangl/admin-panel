...
export default function VerifiedFlat() {
    const router = useRouter();
    const [verified, setVerified] = useState<Flat[]>([]);
    ...
    useEffect(() => {
        const fetchVerifiedFlats = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/v1/admin/verified-flat`, {
                    method: "GET",
                    headers: {
            ...
            <div className="flex">
                ...
                <div className="flex-grow p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-center flex-1">Verified Flat List</h2>
                        <input
                            type="text"
                                    ...
                                    verified
                                        ...
                                        .map((flat, index) => (
                                            <tr key={flat.id} className="hover:bg-gray-100">
                                                ...
                                                <td className="border p-2">{new Date(flat.verifiedByAdminOrAgent).toLocaleDateString()}</td>
                                                ...
                                                <td className="border p-2 text-center">
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            router.push(`/verified-flat/id?id=${flat.id}`);
                                                        }}
                                                    >
                                                        Open
                                                    </button>
