...
export default function NotVerifiedRoom() {
    ...
    useEffect(() => {
        const fetchNotVerifiedRooms = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_URL}/v1/admin/not-verified-room`, {
                    method: "GET",
                    headers: {
            ...
            <div className="flex">
                ...
                <div className="flex-grow p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-semibold text-center flex-1">Not Verified Room List</h2>
                        <input
                            type="text"
                                            ...
                                            <tr key={room.id} className="hover:bg-gray-100">
                                                ...
                                                <td className="border p-2 text-center">
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            router.push(`/not-verified-room/id?id=${room.id}`);
                                                        }}
                                                    >
                                                        Open
                                                    </button>
